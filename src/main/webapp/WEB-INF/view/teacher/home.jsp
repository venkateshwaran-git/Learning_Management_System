...
<nav class="navbar navbar-light bg-dark">   
      <a class="nav-item nav-link active text-white mx-auto font-weight-bold" href="/Skl_Administration/teacher/home">Home</a>
...
<br>
<h2>${ T_admin.firstname } ${ T_admin.lastname }</h2>
<br>
</div>
</body>
</html>